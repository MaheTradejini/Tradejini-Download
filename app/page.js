...
export default function Home() {
  ...
  const handleCardClick1 = () => {
    window.open("https://cp.tradejini.com/Ox1Ux9?_gl=1*aampo0*_ga*MTU2MTkwMTcyNi4xNzI1MjcxMzEx*_ga_PYZ3N13XX4*MTcyOTg1NjM3OC41MC4xLjE3Mjk4NTY2NDYuMC4wLjA", "_blank");
  };
  ...
  const applicationData = [
    {
      ...
      pdfs: [
        { title: "Guidance Note", url: "/files/Application Forms/Equities, Derivatives and Currency Trading/1. Guidance Note.pdf" },
        { title: "Rights And Obligations", url: "/files/Application Forms/Equities, Derivatives and Currency Trading/2. Rights And Obligations.pdf" },
        {
        ...
        { title: "Additional RDD for Options", url: "/files/Application Forms/Equities, Derivatives and Currency Trading/4. Additional RDD for Options.pdf" },
        { title: "Policies And Procedures", url: "/files/Application Forms/Equities, Derivatives and Currency Trading/5. Policies And Procedures.pdf" },
        { title: "VernacularLanguages", url: "/files/Application Forms/Equities, Derivatives and Currency Trading//Vernacular Languages/PNP_in_Diff__Languages-1.zip" },
      ],
    },
    {
      title: "Commodities Trading",
      pdfs: [
        { title: "Guidance Note", url: "/files/Application Forms/Commodity Trading/1.  Guidance Note.pdf" },
        { title: "Rights And Obligations", url: "/files/Application Forms/Commodity Trading/2. Rights And Obligations.pdf" },
        {
          title: "Risk Disclosure Document (RDD)",
          url: "/files/Application Forms/Commodity Trading/3. Risk Disclosure Document (RDD).pdf",
        },
        { title: "Commodity RMS Policy", url: "/files/Application Forms/Commodity Trading/4. Commodity RMS Policy.pdf" },
        { title: "Vernacular Languages", url: "/files/Application Forms/Commodity Trading/Vernacular Languages/PNP_in_Diff__Languages-1.zip" },
      ],
    },
    {
      title: "Demat",
      pdfs: [
        { title: "DDPI Form", url: "/files/Application Forms/Demat/1. DDPI Form.pdf" },
        { title: "Rights And Obligations ", url: "/files/Application Forms/Demat/2. Rights And Obligations.pdf" },
      ],
    },
  ];
  ...
  const modificationData = [
    {
      ...
      pdfs: [
        ...
        { title: "Account Closure Form", url: "/files/Modification Forms/Equities, Derivatives and Currency Trading/3.  Account Closure Form.pdf" },
        {
        ...
        { title: "NOC for Joint Account", url: "/files/Modification Forms/Equities, Derivatives and Currency Trading/7. NOC for Joint Account.pdf" },
      ],
    },
    {
      title: "Demat",
      pdfs: [
        { title: "New DIS Form Issue", url: "/files/Modification Forms/Demat/1. New DIS Form Issue.pdf" },
        { title: "Nomination Form", url: "/files/Modification Forms/Demat/2. Nomination Form.pdf" },
        {
          title: "Dematerialisation Request Form",
          url: "/files/Modification Forms/Demat/3. Dematerialisation Request Form.pdf",
        },
        { title: "Pledge Request Form", url: "/files/Modification Forms/Demat/4. Pledge Request Form.pdf" },
        { title: "Unpledge Request Form", url: "/files/Modification Forms/Demat/5. Unpledge Request Form.pdf" },
        {
        ...
        { title: "BO Seller Buyer link", url: "/files/Modification Forms/Demat/12. BO Seller Buyer link.pdf" },
      ],
    },
  ];
  ...
  const investorData = [
    {
      title: "Equities, Derivatives and Currency Trading",
      pdfs: [
        { title: "Investor Charter", url: "/files/Investor’s corner/Equities, Derivatives and Currency Trading/1. Investor Charter.pdf" },
        { title: "Advisory for Investors", url: "/files/Investor’s corner/Equities, Derivatives and Currency Trading/2.  Advisory for Investors.pdf" },
        { title: "Investor Awareness", url: "/files/Investor’s corner/Equities, Derivatives and Currency Trading/3.  Investor Awareness.pdf" },
        { title: "Investors Education", url: "https://www.bseipf.com/investors_education.html" },
        {
    ...
    },
    {
      ...
      pdfs: [{ title: "Investor Grievance", url: "/files/Investor’s corner/Investor Grievance/1. Investor Grievance.pdf" }],
    },
    {
      title: "Demat",
      pdfs: [{ title: "Investor Charter-DP", url: "/files/Investor’s corner/Demat/1. Investor Charter-DP.pdf" }],
    },
    {
      title: "Risks",
      pdfs: [
